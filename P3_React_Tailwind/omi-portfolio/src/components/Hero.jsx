...
function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-6 pt-20 overflow-hidden">
      <div className="max-w-7xl w-full flex flex-col justify-center items-center text-center gap-6 mt-2">
      {/* Greeting  */}
      <p className="text-[#06b6d4] text-sm sm:text-lg tracking-widest uppercase">Welcome to my portfolio</p>

        {/* Name */}
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-[#f1f5f9]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4 max-w-lg  items-center justify-center w-full">
          <a href="#projects" className="px-6 py-3 bg-[#6366f1] w-full max-w-[200px] text-sm sm:text-lg sm:max-w-lg text-white rounded-lg font-medium hover:bg-[#4f46e5] transition-all duration-300 hover:shadow-lg hover:shadow-[#6366f1]/25">
            View Project
          </a>
          <a href="/my-cv.pdf" download="Umar_Asghar_cv.pdf" className="px-6 py-3 w-full max-w-[200px] text-sm sm:text-lg sm:max-w-lg border border-[#6366f1] text-[#6366f1] rounded-lg font-medium hover:bg-[#6366f1]/10 transition-all duration-300">
         Download CV
          </a>
        </div>
